            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition">
                        ...
                        <Link href="/egresos" className="text-sm text-red-600 hover:text-red-700 font-medium">
                            Ver detalles →
                        </Link>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Link href="/ingresos" className="text-sm text-blue-600 hover:text-blue-700 font-semibold">
                                Ver todos →
                            </Link>
                        </div>
                            ...
                            {ultimosIngresos && ultimosIngresos.length > 0 ? (
                                <>
                                    {ultimosIngresos.map((ingreso) => (
                                        <div key={ingreso.id} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                                            <div className="flex-1">
                                                <p className="font-semibold text-gray-900">
                                                    {ingreso.concepto?.nombre || 'Sin concepto'}
                                                </p>
                                                <p className="text-sm text-gray-500">
                                                    {formatTimeAgo(ingreso.created_at)}
                                                    {ingreso.medioDePago && (
                                                        <span className="ml-2">• {ingreso.medioDePago.nombre}</span>
                                                    )}
                                                </p>
                                            </div>
                                    ...
                                    <Link
                                        ...
                                        className="flex items-center justify-center gap-2 w-full py-3 bg-green-50 hover:bg-green-100 text-green-600 font-semibold rounded-lg transition mt-4"
                                    >
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-500 font-medium mb-3">No hay ingresos registrados</p>
                                    <Link
                                        href="/ingresos/create"
                                        className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-lg font-semibold transition"
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                        </svg>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Link href="/egresos" className="text-sm text-blue-600 hover:text-blue-700 font-semibold">
                                Ver todos →
                            </Link>
                        </div>
                        <div className="space-y-3">
